...
export function DevelopmentTimeline() {
  ...
  return (
    <section className="future-shell relative overflow-hidden px-5 py-20 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(7,95,214,0.05)_1px,transparent_1px),linear-gradient(180deg,rgba(7,95,214,0.05)_1px,transparent_1px)] dark:bg-[linear-gradient(90deg,rgba(0,200,255,0.08)_1px,transparent_1px),linear-gradient(180deg,rgba(0,200,255,0.08)_1px,transparent_1px)] bg-[size:56px_56px]" />
                ...
                >
                  <span
                    className={cn(
                      ...
                      isComplete
                        ? 'border-secondary bg-secondary text-white dark:text-primary shadow-[0_0_34px_rgba(0,200,255,0.45)]'
                  ...
                  <span
                    className={cn(
                      ...
                      isActive
                        ? 'border-secondary/60 bg-white shadow-2xl shadow-secondary/10 dark:bg-white/12 dark:shadow-secondary/10'
              ...
              >
                <span
                  className={cn(
                    ...
                    isComplete
                      ? 'border-secondary bg-secondary text-white dark:text-primary shadow-[0_0_26px_rgba(0,200,255,0.45)]'
                      : 'border-primary/15 bg-primary/8 text-primary dark:border-white/15 dark:bg-white/8 dark:text-white',
                  )}
                >
                  <Icon aria-hidden="true" />
