...
export function TestimonialsSection() {
  ...
  return (
    <section className="future-shell relative overflow-hidden bg-primary px-5 py-20 text-white sm:px-6 lg:px-8 dark:bg-black">
      <div className="absolute inset-0 bg-[linear-gradient(135deg,#07111F,#06111f_56%,#020617)]" />
      ...
      <div className="relative mx-auto max-w-7xl">
              ...
              <button
                ...
                className={`rounded-full border px-4 py-2 text-sm font-semibold transition ${
                  activeCategory === category
                    ...
                    : 'border-white/10 bg-white/[0.06] text-slate-300 hover:border-secondary/70 hover:text-white'
                }`}
                key={category}
        ...
        <div className="relative -mx-5 overflow-hidden px-5 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
          <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-16 bg-gradient-to-r from-primary to-transparent dark:from-black" />
          <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-16 bg-gradient-to-l from-primary to-transparent dark:from-black" />
